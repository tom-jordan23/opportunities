...
**Start with your situation, not your dreams.**
...
### Work & Travel
*Earn money while experiencing new places. Most include housing.*
...
| [Working Holiday - New Zealand](opportunities/work-and-travel/working-holiday-visa-new-zealand.md) | Your cost | $2,000-3,500 | Year abroad, adventure |
| [Working Holiday - Canada](opportunities/work-and-travel/working-holiday-visa-canada.md) | Your cost | $1,500-3,000 | Year abroad, no language barrier |
| [Coolworks Seasonal Jobs](opportunities/work-and-travel/coolworks-seasonal-jobs.md) | Varies | Varies | Finding seasonal work anywhere |

**Category overview:** [Work & Travel Overview](opportunities/work-and-travel/OVERVIEW.md)

---

### Skills & Trades
*Learn marketable skills that lead to stable careers.*
...
### Service & Volunteer
*Structured programs with training, community, and purpose.*

| Opportunity | Stipend | Housing | Education Award | Duration |
|-------------|---------|---------|-----------------|----------|
...
### Entrepreneurship
*Build your own income streams with flexibility.*

| Opportunity | Startup Cost | Income Potential | Stability |
|-------------|--------------|------------------|-----------|
| [Gig Work Strategies](opportunities/entrepreneurship/gig-work-strategies.md) | Vehicle + phone | $1,000-3,000/mo | Low |
...
These haven't been fully documented yet but are worth researching:
...
| Opportunity | Key Info | Where to Start |
|-------------|----------|----------------|
| **Van Life** | Requires vehicle ($3-30k), $500-1,500/mo living costs, parking challenges | r/vandwellers, Cheap RV Living |
| **Workamping** | Work at RV parks for free site + pay, usually need your own RV | workamper.com, Coolworks |
| **House/Pet Sitting** | Free housing worldwide, build reputation over time | TrustedHousesitters.com, Rover |
| **Freelance Writing** | Low barrier, $0.05-0.50/word starting, takes time to build | Contently, r/freelanceWriters |
| **Social Media Management** | Help small businesses, $300-2,000/mo per client | Direct outreach, Upwork |
...
### Red Flags (Walk Away)
- Any job that asks you to pay upfront fees
- Guaranteed income or placement promises
- Pressure to decide immediately
- Requests for bank info or SSN before verification
- Communication only through WhatsApp/Telegram
- Vague job descriptions with high pay claims

### Yellow Flags (Research More)
- Third-party recruiters (verify they're authorized)
- Required training from a specific provider
- Multi-level or referral incentives
- Programs that are very new (< 2 years)

### How to Verify Any Opportunity
1. Search "[program name] + scam" and "[program name] + reddit"
2. Check for a real physical address and verifiable employees
3. Look for independent reviews (not just testimonials on their site)
4. Verify credentials or accreditation with official bodies
5. Never send money before confirming legitimacy

---

## How These Opportunities Connect

Many paths lead to others. Here are common progressions:

```
Conservation Corps → SCA → Forest Service/NPS permanent
                   ↘
